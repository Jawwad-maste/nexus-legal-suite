            ...
            {user && (
              <div className="flex items-center space-x-2">
                ...
                <Button
                  ...
                  variant="outline"
                  size="sm"
                  className="flex items-center space-x-1 border-blue-600 text-blue-600 hover:bg-blue-50 dark:hover:bg-blue-900/20"
                >
            ...
            <div className="px-2 pt-2 pb-3 space-y-1">
              ...
              {user && (
                <Button
                  ...
                  variant="outline"
                  className="w-full mt-4 flex items-center space-x-2 border-blue-600 text-blue-600 hover:bg-blue-50 dark:hover:bg-blue-900/20"
                >
                  <LogOut className="w-4 h-4" />
                  <span>Sign Out</span>
                </Button>
